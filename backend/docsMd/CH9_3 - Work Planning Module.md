...
- Labor (Budget Factor) = (Total Labor Cost * Hrs. a Day * Crew Days * %Labor Factor), then add to     the total Planned Budget (option S) 

- Equipment (Budget Factor) = (Total Equip. Cost * Hrs. a Day * Crew Days * %Equip. Factor), then     add to the total planned budget (option S) 

- Material (Budget Factor) = (Total Material Cost * Crew Days * %Material Factor), then add to the     total planned budget (option S) 
...
#### *PLEASE NOTE: THIS FUNCTIONALITY HAS CHANGED SIGNIFICANTLY IN VERSION 15* 
...
- Labor = Rate * 8hrsaday * Crew Days 

- Equipment = Rate * 8hrsaday * Crew Days 
